...
###############################################################################
# Script Name: convert_to_fasta.sh
# Description: Extracts sequences annotated with PF00014 from a CSV file and
#              outputs them in FASTA format with proper headers.
